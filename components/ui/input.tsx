  ...
  return (
    <div className="relative">
      <input
        ...
        className={cn(
          "peer placeholder-transparent flex h-12 w-full rounded-md border border-input bg-gray-100 autofill:bg-gray-100 px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        ref={ref}
